...
const paths = [
  {
    number: '01',
    label: 'COLOCAR MEU NEGÓCIO NA INTERNET',
    detail: 'Uma presença digital para começar a ser encontrado.',
  },
  {
    number: '02',
    label: 'MELHORAR O QUE JÁ TENHO',
      ...
      <div className="cta__inner">
        <header className="cta__header">
          ...
          <p className="cta__intro">
            ...
            Escolha um ponto de partida — ou invente o seu.
          </p>
        </header>
        ...
        <div className="cta__active">
          <span className="cta__active-line" />

          <p key={activePath}>
            {active.detail}
          </p>

          <span className="cta__active-action">
            VAMOS CONVERSAR
